...
return [
    ...
    'timestamp' => 1699568537,
    'checksum' => 'e3af6463dd00f8c4c500354ba5e5d365',
    'files' => [
        'user/config' => [
            'media' => [
        ...
        'user/themes' => [
            'themes/developer' => [
                'file' => 'user/themes/developer/developer.yaml',
                'modified' => 1627860770
            ],
            'themes/developer-me' => [
    ...
    'data' => [
        'themes' => [
                ...
                'profile' => [
                    ...
                    'information' => [
                        ...
                        2 => [
                            ...
                            'text' => 'Toki Mabogunje & Co.'
                        ],
                        3 => [
                            'icon' => 'envelope',
                            'label' => 'Email',
                            'url' => 'mailto:damola@mabogunje.net',
                            'text' => 'damola@mabogunje.net'
                        ],
                        4 => [
                            'icon' => 'link',
                            'label' => 'Website',
                            'url' => 'http://mabogunje.net',
                            'text' => 'http://mabogunje.net'
                        ],
                        5 => [
                            'icon' => 'newspaper-o',
                            'label' => 'Newsletter',
                            'url' => 'https://theredstringblog.com/',
                            'text' => 'https://theredstringblog.com/'
                        ]
                    ]
                ],
                'contact_url' => 'mailto:damola@mabogunje.net',
                'resume' => 'user/themes/developer-me/assets/files/resume.pdf',
                'github' => 'mabogunje',
                'rss_feed' => [
                    'url' => 'https://theredstringblog.com/rss/',
                    'limit' => 1,
                    'date_fmt' => 'Do MMM[,] YYYY',
                    'effect' => 'slideFast'
                ],
                'linkedin' => 'http://linkedin.com/in/damolamabogunje',
                'social' => [
                    'networks' => [
                        0 => [
                            'url' => 'http://linkedin.com/in/damolamabogunje',
                            'icon' => 'linkedin',
                            'title' => NULL
                        ],
                        1 => [
                            'url' => 'http://twitter.com/d4mola',
                            'icon' => 'twitter',
                            'title' => ''
                        ],
                        2 => [
                            'url' => 'http://github.com/mabogunje',
                            'icon' => 'github-alt',
                            'title' => NULL
                        ],
                        3 => [
                            'url' => 'http://gravatar.com/mabogunje',
                            'icon' => 'wordpress',
                            'title' => NULL
                        ],
                        4 => [
                            'url' => 'http://mabogunje.deviantart.com/',
                            'icon' => 'deviantart',
                            'title' => NULL
                        ]
                    ]
                ...
                'streams' => [
                    'schemes' => [
                        'theme' => [
                            ...
                            'prefixes' => [
                                '' => [
                                    0 => 'user/themes/developer-me',
                                    1 => 'user/themes/developer'
                                ]
                            ]
                        ]
                    ]
            ...
            'x-corporation' => [
                ...
                'footer_blocks' => [
                    0 => [
                        'content' => 'Continually matrix cross functional opportunities whereas ethical information. Compellingly streamline enabled human capital before resource-leveling internal or "organic".',
                        'icons' => false
                    ],
                    1 => [
                        'title' => 'We work for your profit',
                        'content' => 'Distinctively expedite viral materials rather than out-of-the-box solutions. Credibly empower revolutionary ROI rather than unique products. Collaboratively maximize principle-centered ideas before highly efficient data. Phosfluorescently.',
                        'logo' => false,
                        'icons' => false
                    ],
                    2 => [
                        'title' => 'Contact Us Today',
                        'content' => 'Call Us 666 777 888 OR 111 222 333

Send an Email on <a href="mailto:#">contact@domain.com</a>

Visit Us 123 Fake Street- Blla 12358
Fake Kingdom',
                        'logo' => false
                    ]
                ],
                'copyright' => 'Copyright &copy; 2016 | X-Corporation Designed And Developed By: <a href="http://www.uicookies.com">uiCookies</a>',
                'google_maps_api_key' => 'AIzaSyDbmnZP5BTkpv5blTprRtUvS99zbvyoSAQ'
            ]
        ],
        'plugins' => [
            'markdown-notices' => [
...
node_modules'
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'Damola Mabogunje: Software Engineer & Author'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
